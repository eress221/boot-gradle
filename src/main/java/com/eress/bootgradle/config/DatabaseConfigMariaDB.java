package com.eress.bootgradle.config;
...
@MapperScan(value = {"com.eress.bootgradle.mapper"}, sqlSessionFactoryRef = "sqlSessionFactory")
@Configuration
...
//    }
    ...
    public SqlSessionFactory sqlSessionFactory(@Qualifier("dataSource") DataSource dataSource) throws Exception {
        ...
        sessionFactory.setTypeAliasesPackage("com.eress.bootgradle.model");
